...
TVS Jugendtrainer is a React Native + Expo app for youth soccer coaches: teams, players, tournaments, match events, and AI match reports.

Backend: **Azure Functions + Azure PostgreSQL**.
...
- Expo: ~53.0.12
- Expo Router: ~5.1.0
- Azure backend: `azure-functions/` (Functions v4) + PostgreSQL
